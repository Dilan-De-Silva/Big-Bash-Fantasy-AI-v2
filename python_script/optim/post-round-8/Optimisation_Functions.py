...
def optimise_setup_fn(
    ...
    return    points_r9, price_r9, weight_r9, in_team_r9, available_r9, wk_weight_r9, bat_weight_r9, bowl_weight_r9, \
...
def optimise_fn_efp(
    ...
    # Round 8 (Previous Round)
    x_r8 = [m.add_var(var_type=BINARY) for i in total_player_r9] # Selected (15)
    for i in total_player_r9:
        m += x_r8[i] == int(in_team_r9.iloc[i])
    # Round 9
    ...
    rounds_data = [
        ...
        (player_df_r9, player_df_r9, x_r8, x_r9, {}, team_play_cnt_r9, "r8_r9"), #Same DFs as current round
    ]
...
def _run_single_sfp_sim(sim_id, conf_int, lower_z_thresh, upper_z_thresh, current_rnd, sim_budget, player_df_raw, price_df, price_model_obj_1, price_model_obj_2, price_model_obj_3, optimise_fn_efp):
    ...
    budget_r9, total_budget_r9, team_play_cnt_r9, total_team_player_r9, player_df_r9, cnt_r9, max_player_r9 =  optimise_setup_fn(
        player_df_r9, sim_budget)
    
    # b. Run optimization
    sel_player_df, sel_player_df_r9 = optimise_fn_efp(
        # Round 1
        # points_r1, price_r1, weight_r1, in_team_r1, available_r1, wk_weight_r1, bat_weight_r1, bowl_weight_r1,
        # play_cnt_r1, total_player_r1, wk_cnt_r1, total_wk_r1, bat_cnt_r1, total_bat_r1, bowl_cnt_r1, total_bowl_r1,
        # budget_r1, total_budget_r1, player_df_r1, cnt_r1, max_player_r1,
    ...
    sim_sel_players = sel_player_df_r9[['Name']]
    sim_sel_players['Simulation'] = sim_id + 1

    # Drop dataframes to free up memory
    del player_df_init, sel_player_df_r9, sel_player_df
    del price_r9
    del weight_r9
    del in_team_r9
    del available_r9
    ...
    del total_player_r9
    del total_budget_r9
    del team_play_cnt_r9
    del total_team_player_r9
    del points_r9
    del player_df_r9
