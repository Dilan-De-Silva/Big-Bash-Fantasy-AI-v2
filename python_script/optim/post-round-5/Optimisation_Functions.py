...
def optimise_setup_fn(
    player_df_r6, player_df_r7, player_df_r8, player_df_r9, init_budget
): 
    # Round 1
    ...
    return    points_r6, price_r6, weight_r6, in_team_r6, available_r6, wk_weight_r6, bat_weight_r6, bowl_weight_r6, \
...
def optimise_fn_efp(
    ...
    # Round 5 (Previous Round)
    x_r5 = [m.add_var(var_type=BINARY) for i in total_player_r6] # Selected (15)
    for i in total_player_r6:
        m += x_r5[i] == int(in_team_r6.iloc[i])
    # Round 6
    ...
    rounds_data = [
        ...
        (player_df_r6, player_df_r6, x_r5, x_r6, {}, team_play_cnt_r6, "r5_r6"), #Same DFs as current round
    ...
    m.objective = maximize(obj_r6 + obj_r7 + obj_r8 + obj_r9)
    ...
    sel_player_df = pd.concat([sel_player_df_r6, sel_player_df_r7,sel_player_df_r8, sel_player_df_r9], ignore_index=True)
    ...
    return sel_player_df, sel_player_df_r6, sel_player_df_r7,sel_player_df_r8, sel_player_df_r9
...
def _run_single_sfp_sim(sim_id, conf_int, lower_z_thresh, upper_z_thresh, current_rnd, sim_budget, player_df_raw, price_df, price_model_obj_1, price_model_obj_2, price_model_obj_3, optimise_fn_efp):
    ...
    budget_r9, total_budget_r9, team_play_cnt_r9, total_team_player_r9, player_df_r9, cnt_r9, max_player_r9 =  optimise_setup_fn(
        player_df_r6, player_df_r7, player_df_r8, player_df_r9, sim_budget)
    
    # b. Run optimization
    sel_player_df, sel_player_df_r6, sel_player_df_r7,sel_player_df_r8, sel_player_df_r9 = optimise_fn_efp(
        # Round 1
        # points_r1, price_r1, weight_r1, in_team_r1, available_r1, wk_weight_r1, bat_weight_r1, bowl_weight_r1,
        # play_cnt_r1, total_player_r1, wk_cnt_r1, total_wk_r1, bat_cnt_r1, total_bat_r1, bowl_cnt_r1, total_bowl_r1,
        # budget_r1, total_budget_r1, player_df_r1, cnt_r1, max_player_r1,
    ...
    sim_sel_players = sel_player_df_r6[['Name']]
    sim_sel_players['Simulation'] = sim_id + 1

    # Drop dataframes to free up memory
    del player_df_init, sel_player_df_r6, sel_player_df_r7,sel_player_df_r8, sel_player_df_r9, sel_player_df
    del price_r6, price_r7, price_r8, price_r9
    del weight_r6, weight_r7, weight_r8, weight_r9
    del in_team_r6, in_team_r7, in_team_r8, in_team_r9
    del available_r6, available_r7, available_r8, available_r9
    del wk_weight_r6, wk_weight_r7, wk_weight_r8, wk_weight_r9
    del bat_weight_r6, bat_weight_r7, bat_weight_r8, bat_weight_r9
    del bowl_weight_r6, bowl_weight_r7, bowl_weight_r8, bowl_weight_r9
    del play_cnt_r6, play_cnt_r7, play_cnt_r8, play_cnt_r9
    del budget_r6, budget_r7, budget_r8, budget_r9
    del total_player_r6, total_player_r7, total_player_r8, total_player_r9
    del total_budget_r6, total_budget_r7, total_budget_r8, total_budget_r9
    del team_play_cnt_r6, team_play_cnt_r7, team_play_cnt_r8, team_play_cnt_r9
    del total_team_player_r6, total_team_player_r7, total_team_player_r8, total_team_player_r9
    del points_r6, points_r7, points_r8, points_r9
    del player_df_r6, player_df_r7, player_df_r8, player_df_r9
