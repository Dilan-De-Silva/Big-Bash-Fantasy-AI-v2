...
def roll_rnd_price_fn(player_df_init, price_df, current_rnd, 
    ...
    player_df = player_df_init_2.groupby(['Name', 'Price', "Team", "Round", "Wk_f", "Bat_f", "Bowl_f", "Role", "weight","Available", "In_Team" ,"On_Bench"], as_index=False).agg(
...
def optimise_setup_fn(
    ...
    return points_r1, price_r1, weight_r1, in_team_r1, on_bench_r1, available_r1, wk_weight_r1, bat_weight_r1, bowl_weight_r1, \
...
def optimise_fn_efp(
    ...
    for i in total_player_r1:
        ...
        if on_bench_r1[i] == 1:
            m += p_r1[i] == 0  # Bench-locked players must NOT be playing
